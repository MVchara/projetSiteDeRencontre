		...
		<div class="head">
			...
			<center>
				<nav>
					<div class="table">
						<ul>
							<li class="acceuil"><a href="editer.php">Editer Profil</a></li>
							<li class="amicale"><a href="contacter.php">Ma Messagerie</a></li>
							<li class="amicale"><a href="abonnement.php">S'abonner</a></li>
							<li class="connexion"><a href="index.php">Se déconnecter</a></li>
						</ul>
					</div>
				</nav>
			</center>
